...
<form action="../controller/proses_pembelian.php?aksi=update" method="post">
<?php
foreach($db->edit($_GET['id']) as $d){
?>
<table>
<tr>Edit Data Pembelian</tr>
    <tr>
        <td>Id Pembelian</td>
        <td>
            <input type="text" name="id_pembelian" value="<?php echo $d['id_pembelian'] ?>">
        </td>
    </tr>
    <tr>
        <td>Id Produk</td>
    ...
    <tr>
        <td>Tanggal</td>
        <td>
            <input type="text" name="tanggal" value="<?php echo $d['tanggal'] ?>">
        </td>
    </tr>
    <tr>
        <td></td>
